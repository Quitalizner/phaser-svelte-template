...
const config: Configuration = {
  ...
  plugins: [
    ...
    new CopyPlugin({                                    // Works perfectly with the hot reload feature. Automatically replaces any files modified in the 'from' folder when server is running  
      patterns: [
        { from: path.resolve(__dirname, 'src/game/src/assets'), to: path.resolve(__dirname, 'public/game/src/assets') },
        { from: path.resolve(__dirname, 'src/index.html'), to: path.resolve(__dirname, 'public/index.html') },
        { from: path.resolve(__dirname, 'src/favicon.png'), to: path.resolve(__dirname, 'public/favicon.png') },
      ],
    }),
  ],
